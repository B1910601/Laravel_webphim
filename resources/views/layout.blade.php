         ...
         <div class="container">
            <div class="row" id="headwrap">
               <div class="col-md-3 col-sm-6 slogan">
                 <img src="https://cdn6.kenhvn2.com/motfim.png">
                  </a>
               </div>
              ...
              <input id="timkiem" type="text" name="search" class="form-control" placeholder="Tìm kiếm..." autocomplete="off" >
               ...
               @if(Auth::check())
              <a class="btn btn-primary" href="">Chào {{Auth::user()->name}}</a>
                <a class="btn btn-primary" href="{{route('dang-xuat')}}">Logout</a>
             @else
             <a class="btn btn-primary" href="{{route('dang-nhap')}}">Đăng nhập</a>
             <a class="btn btn-primary" href="{{route('dang-ky')}}">Đăng ký</a>
             @endif
                  </div>
               </div>
            </div>
            ...
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     <img class="img-responsive" src="https://cdn6.kenhvn2.com/motfim.png
" alt="Phim hay 2021- Xem phim hay nhất" />
                  </div>
                  Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">[David@email&#160;.com]</a>
               </div>
                 <div class="footer-logo">
                  <p class="p2" style="font-size: 14px; padding-top: 12px;"> Copyright 2021 © MEPHIMMOI.NET
               Xem phim mới miễn phí nhanh chất lượng cao. Xem Phim online Việt Sub, Thuyết minh, lồng tiếng chất lượng HD. Xem phim nhanh online chất lượng cao
                ...
                Email Liên hệ : <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">[huynhvi@gmail&#160;.com]</a>
               </div>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v14.0" nonce="yoC2Z5nz"></script>
       <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v15.0" nonce="AM46tsyk"></script>
         ...
         $(document).ready(function(){
            ...
            $('#result').html('');
             $('#result').css('display','none');
                  ...
                  // <img src="/uploads/movie/'+value.image+'" height="40" width="40" class=""/>'+value.title+'<br> -> <span class="text-muted">'+value.description+'</span>
           //     }else{
           //        $('#result').css('display','none');
           //     }
           // }) 
