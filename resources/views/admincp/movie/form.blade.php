                    ...
                    @endif
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            {!! Form::select('resolution', ['0'=>'HD','1'=>'SD','2'=>'FullHD','3'=>'Trailer'], isset($movie) ? $movie->status : '', ['class'=>'form-control']) !!}
                        </div>
                         <div class="form-group">
                            {!! Form::label('Phụ đề', 'Phụ đề', []) !!}
                            {!! Form::select('phude', ['0'=>'Phụ đề','1'=>'Vietsub'], isset($movie) ? $movie->phude : '', ['class'=>'form-control']) !!}
                        </div>
                        <div class="form-group">
