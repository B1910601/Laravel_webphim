...
<div class="row container" id="wrapper">
      ...
      <a href="{{route('country',[$movie->country->slug])}}">{{$movie->country->title}}</a> » <span>
               ...
               <section id="content" class="test">
                  <div class="clearfix wrap-content">
                   ...
                   <a href="{{url('xem-phim/'.$movie->slug.'/tap-'.$episode_tapdau->episode)}}" class="bwac-btn">
                                       ...
                                       @endif
                                    @else
                                       <a href="#watch_trailer"  style="display: block;" class="watch_trailer btn btn-primary">Xem trailer</a>
                           ...
                           <a href="{{route('dang-nhap')}}">   <ul class="item">
                              ...
                              <li   class="item"
                                              style="cursor:pointer;  
                                                  ...
                                                  <li  class="item" title="star_rating"
                              ...
                              @endphp
                                 <div class="fb-like" data-href="{{$current_url}}" data-width="" data-layout="standard" data-action="like" data-size="small" data-share="true"></div>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="entry-content htmlwrap clearfix">
                        ...
                        <div class="video-item halim-entry-box">
                           <article id="post-38424" class="item-content">
                             <div class="fb-comments"  data-href="{{$current_url}}" data-width="100%" data-numposts="10" style="color: red;"></div>
                           </article>
                        </div>
                     </div>
                        ...
                        <h3 class="section-title"><span>CÓ THỂ BẠN MUỐN XEM</span></h3>
                                    ...
                                    <article class="thumb grid-item post-38494">
                                      ...
                                      @endif
                                       ...
                                       <p class="entry-title">{{$hot->title}}</p><p class="original_title">{{$hot->name_eng}}</p>
                                       </div>
                                       </div>
                                       </a>
                                       </div>
