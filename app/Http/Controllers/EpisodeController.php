    ...
    public function select_movie(){
        ...
        if($movie->thuocphim=='phimbo'){
             for($i=1;$i<=$movie->sotap;$i++){
                ...
                $output.='<option value="HD">HD</option><option value="FullHD">FullHD</option><option value="FullHD">CAM</option><option value="FullHD">SER1</option><option value="FullHD">SER2</option>';
